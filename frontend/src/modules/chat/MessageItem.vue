<template>
  ...
  >
    ...
    <div class="message-body">
      ...
      <!-- QuickActions -->
      <QuickActions
        v-if="message.keyboard?.length"
        :actions="message.keyboard"
        :streaming="message.isThinking || false"
        @action="(action: any) => $emit('quickAction', action)"
      />
